...
import UltraOptimizedNeurobase from './components/UltraOptimizedNeurobase';

// Import other components as fallback
import OptimizedNeurobase from './components/OptimizedNeurobase';
...
function App() {
  ...
  const exportPerformanceData = () => {
    ...
    link.href = url;
    link.download = `neurobase-ultra-optimized-benchmark-${new Date().toISOString().split('T')[0]}.json`;
    link.click();
